SELECT ca.name AS category, COUNT(order_id) AS row_per_Category, AVG(quantity) AS avg_product_quantity 
...
GROUP BY ca.name HAVING avg_product_quantity > 21
ORDER BY row_per_Category DESC;